# -*- encoding: utf-8 -*-
# stub: opentelemetry-instrumentation-sidekiq 0.25.7 ruby lib

Gem::Specification.new do |s|
  s.name = "opentelemetry-instrumentation-sidekiq".freeze
  s.version = "0.25.7".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/open-telemetry/opentelemetry-ruby-contrib/issues", "changelog_uri" => "https://rubydoc.info/gems/opentelemetry-instrumentation-sidekiq/0.25.7/file/CHANGELOG.md", "documentation_uri" => "https://rubydoc.info/gems/opentelemetry-instrumentation-sidekiq/0.25.7", "source_code_uri" => "https://github.com/open-telemetry/opentelemetry-ruby-contrib/tree/main/instrumentation/sidekiq" } if s.respond_to? :metadata=
